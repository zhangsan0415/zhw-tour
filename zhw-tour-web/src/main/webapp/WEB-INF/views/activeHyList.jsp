...
<div id="wrapper">
    ...
    <div id="sidebar-nav" class="sidebar">
        <div class="sidebar-scroll">
            ...
            <nav>
                <ul class="nav">
                    <li><a href="home.html" class=""><i class="lnr lnr-home"></i> <span>系统首页</span></a></li>
                    <li>
                    ...
                    <li>
                        <a href="#subServer" data-toggle="collapse" class="active" aria-expanded="true">
                            <span>服务中心</span>
                            <i class="icon-submenu lnr lnr-chevron-left"></i></a>
                        <div id="subServer" class="collapse in">
                            <ul class="nav">
                                <li><a href="activationMember.html" class="">已开通会员</a></li>
                                <li><a href="noActivationMember.html" class="active">未开通会员</a></li>
                            </ul>
                        </div>
                    </li>
                    <li>
    ...
    <div class="main">
        ...
        <div class="main-content">
            ...
            <!--lock start-->
            <div class="panel col-md-push-4  col-md-4">
                <form action="">
            ...
            <div style="display: none;"  class="panel panel-headline demo-icons">
                <div class="panel-heading">
