...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath%>static/assets/linearicons/style.css">
                ...
                <ul class="nav">
                    ...
                    <li>
                        ...
                        <div id="subMarket" class="collapse ">
                            <ul class="nav">
                                <li><a href="member.html" class="">会员</a></li>
            ...
            <div class="panel panel-headline demo-icons">
                ...
                <form class="panel-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" value="15615677981" disabled="disabled">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1" style="display:block">验证码</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" style="width:15%;display:inline-block" placeholder="验证码">
