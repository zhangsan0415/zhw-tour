			...
			<div class="sidebar-scroll">
				...
				<nav>
					<ul class="nav">
						...
						<c:if test="${sessionScope.userInfo.hyLevel > 1 || sessionScope.userInfo.ifAdmin==0}"><!-- 金卡或者钻石 -->
							<li><a href="#subServer" data-toggle="collapse"
								...
								<div id="subServer" class="collapse ">
									...
									<%-- <c:if test="${sessionScope.userInfo.ifBdCenter !=0 }"> --%>
										<li><a id='applyBdCenter' href="<%=basePath%>home/toSignInAdmin.do" class="">开通报单中心</a></li> 
									<%-- </c:if> --%>
									</ul>
								</div></li>
						</c:if>
