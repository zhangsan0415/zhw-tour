        ...
        <div class="main-content">
            ...
            <div class="container-fluid panel">
                <div class="profile-info ">
                    ...
                    <div class="row">
                        <div class="col-md-2 text-right padding-bottom-10">奖金积分 ：</div><div class="col-md-10 text-left text-danger padding-bottom-10 ">35.40</div>
                        <div class="col-md-2 text-right padding-bottom-10">旅游积分  ：</div>
                        <div class="col-md-10 text-left  padding-bottom-10 text-danger">0.0.6 	<h6 class="text-danger">提现手续费 5 %，提现金额倍数为 100 。</h6></div>
                        ...
                        <div class="col-md-2 text-right padding-bottom-10">提现金额  ：</div><div class="col-md-10 text-left padding-bottom-10"> <input type="text" class="form-control input-sm"/></div>
                        <div class="col-md-3 text-right margin-top-30  padding-bottom-10"><input type="button" value="申请提现" class="btn btn-primary"/></div>
                </div>
